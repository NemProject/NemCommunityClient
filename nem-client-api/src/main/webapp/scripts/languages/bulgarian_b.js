define({
	...
	texts: {
		...
		faults: {
			...
			128: 'Предоставеният адрес е невалиден.',
			...
			602: 'Не могат да се извършват никакви операции докато не се зареди напълно db',
		...
		common: {
			...
			appStatus: {
				...
				loading: 'Зареждане на блокове от db до блок: ',
				booting: "Зарежда NIS...",
